...
import "./Style/StyleHomeContent.css"
  ...
  return (
    <Fragment>
      ...
      <div className="container mx-auto py-5 sm:py-16">
        <div class="grid gap-2 grid-cols-2 px-5">
          <div className="colleft-title">
          ...
          <div className="colright-title">
            <img src="http://demo2.cybersoft.edu.vn/static/media/slider2.f170197b.png" alt="" className="w-50 hero__img" />
          </div>
        </div>
        <button
          onClick={(e) => {
